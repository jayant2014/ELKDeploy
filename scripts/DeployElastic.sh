...
then
    ...
    cmd "cp ../centrepos/elastic.repo /etc/yum.repos.d/" "elastic.repo copied" "Copying elastic repo failed."
...
then
    ...
    echo -e "Adding elasticsearch as a service...."
    cmd "update-rc.d elasticsearch defaults 95 10" "elasticsearch added as a service." "Adding elsaticsearch as a service failed."
